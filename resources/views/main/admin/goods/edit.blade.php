                        ...
                        <form action="{{ route('menu.goods.update', $goods->id) }}" method="post">
                            ...
                            <div class="template-demo">
                                <div class="mdc-layout-grid__inner">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="mdc-text-field__input" name="price_sell" type="number" value="{{ $goods->price_sell }}" required id="text-field-hero-input">
                                            @if($errors->has('price_sell'))
                                            <strong class="text-warning">{{ $errors->first('price_sell') }}</strong>
                                            @endif
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                                    <label for="text-field-hero-input" class="mdc-floating-label">Price Sell</label>
                                                </div>
                                                <div class="mdc-notched-outline__trailing"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="mdc-text-field__input" name="price_buy" type="number" value="{{ $goods->price_buy }}" required id="text-field-hero-input">
                                            @if($errors->has('price_buy'))
                                            <strong class="text-warning">{{ $errors->first('price_buy') }}</strong>
                                            @endif
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                                    <label for="text-field-hero-input" class="mdc-floating-label">Price Buy</label>
                                                </div>
                                                <div class="mdc-notched-outline__trailing"></div>
                                            </div>
                                        </div>
