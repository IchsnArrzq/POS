            ...
            <form action="{{ route('menu.goods.store') }}" method="post">
              ...
              <div class="template-demo">
                <div class="mdc-layout-grid__inner">
                  ...
                  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                    <div class="mdc-text-field mdc-text-field--outlined">
                      <input class="mdc-text-field__input" name="price_sell" type="number" required id="text-field-hero-input">
                  ...
                  <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                    <div class="mdc-text-field mdc-text-field--outlined">
                      <input class="mdc-text-field__input" name="price_buy" type="number" required id="text-field-hero-input">
                  ...
                  <table class="table table-hoverable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{{ $goods->price_sell }}</td>
                        <td>{{ $goods->price_buy }}</td>
                        <td>{{ $goods->stock }}</td>
